...
routes.push({
    method: 'POST',
    path: '/locations/{locationId}/impression/text',
...
routes.push({
    method: 'POST',
    path: '/locations/{locationId}/impression/image',
    handler: {
        proxy: {
...
routes.push({
    method: 'POST',
    path: '/locations/{locationId}/impression/video',
    handler: {
        proxy: {
...
routes.push({
    method: 'POST',
    path: '/locations/{locationId}/impression/audio',
    handler: {
        proxy: {
    ...
    handler: {
        proxy: {
            mapUri: (request, callback) => {
                callback(null, 'http://localhost:3453/file/'
                    + request.params.fileId + '/'
                    + request.params.name + '.' + request.params.ext)
            }
        }
    },
    config: {
